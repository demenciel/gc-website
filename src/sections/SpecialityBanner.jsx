...
const SpecialityBanner = () => {
  return (
    <div
      id="specialitybanner"
      className="w-full px-16 h-3/4-screen relative flex flex-col flex-grow md:flex-row lg:flex-row overflow-hidden justify-evenly"
    >
      ...
      <div className=" absolute bottom-0 left-0 opacity-50 w-[512px]">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          version="1.1"
          xmlns:xlink="http://www.w3.org/1999/xlink"
