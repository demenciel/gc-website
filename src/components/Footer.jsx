      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="flex items-center">
              {isQuebec ? (
                <a className="text-text" href="https://www.google.com/maps/place/6021+Bd+Wilfrid-Hamel,+L'Ancienne-Lorette,+QC+G2E+2H3/@46.8195505,-71.2436363,17z/data=!3m1!4b1!4m6!3m5!1s0x4cb883834e666667:0x1f24242424242424!8m2!3d46.8195505!4d-71.2410614!16s%2Fg%2F11c5r3x0r?entry=ttu" target="_blank" rel="noopener noreferrer">
                ...
                <a className="text-text" href="https://www.google.com/maps/place/100+Rue+de+la+Rivi%C3%A8re,+Chicoutimi,+QC+G7H+2B1/@48.425311,-71.061021,17z/data=!3m1!4b1!4m6!3m5!1s0x4b2a3d1000000001:0x1000000000000001!8m2!3d48.425311!4d-71.0584461!16s%2Fg%2F11c5r3x0r?entry=ttu" target="_blank" rel="noopener noreferrer">
                  <address className="not-italic text-left">
                    690 Bd Talbot<br />
                    Chicoutimi, QC G7H 4A9<br />
                    Canada
                  </address>
                </a>
              )}
